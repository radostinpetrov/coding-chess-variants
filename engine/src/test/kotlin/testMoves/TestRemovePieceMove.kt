...
class TestRemovePieceMove {
    ...
    fun removePieceMoveLeavesSquareEmpty() {
        ...
        Move.SimpleMove.BasicMove(Coordinate2D(4, 1), Coordinate2D(4, 3), StandardWhitePawn(player1), player1)
        Move.SimpleMove.BasicMove(Coordinate2D(3, 6), Coordinate2D(3, 4), StandardBlackPawn(player2), player2)
        Move.SimpleMove.RemovePieceMove(player1, StandardWhitePawn(player2), Coordinate2D(3, 4))
    ...
    fun removePieceMoveFieldsTest() {
        ...
        val removePieceMove = Move.SimpleMove.RemovePieceMove(player2, bishopPiece, Coordinate2D(34, 4))
