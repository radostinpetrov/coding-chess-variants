...
class CapablancaChessTest {
    ...
    fun boardIsInitialized() {
        ...
        val initPiecesTest = listOf(
            ...
            Pair(StandardWhitePawn(mockHumanPlayer1), Coordinate2D(8, 1)),
            Pair(StandardWhitePawn(mockHumanPlayer1), Coordinate2D(9, 1)),
            ...
            Pair(StandardBlackPawn(mockHumanPlayer2), Coordinate2D(8, 6)),
            Pair(StandardBlackPawn(mockHumanPlayer2), Coordinate2D(9, 6)),
            // Rooks
            ...
            Pair(Rook(mockHumanPlayer2), Coordinate2D(9, 7)),
            // Knights
            Pair(Knight(mockHumanPlayer1), Coordinate2D(1, 0)),
            Pair(Knight(mockHumanPlayer1), Coordinate2D(8, 0)),
            Pair(Knight(mockHumanPlayer2), Coordinate2D(1, 7)),
            Pair(Knight(mockHumanPlayer2), Coordinate2D(8, 7)),
            // Cardinals
            Pair(Cardinal(mockHumanPlayer1), Coordinate2D(2, 0)),
            Pair(Cardinal(mockHumanPlayer2), Coordinate2D(2, 7)),
            // Marshals
            Pair(Marshal(mockHumanPlayer1), Coordinate2D(7, 0)),
            Pair(Marshal(mockHumanPlayer2), Coordinate2D(7, 7)),
            // Bishops
            Pair(Bishop(mockHumanPlayer1), Coordinate2D(3, 0)),
            Pair(Bishop(mockHumanPlayer1), Coordinate2D(6, 0)),
            Pair(Bishop(mockHumanPlayer2), Coordinate2D(3, 7)),
            Pair(Bishop(mockHumanPlayer2), Coordinate2D(6, 7)),
            // Queens
            Pair(Queen(mockHumanPlayer1), Coordinate2D(4, 0)),
            Pair(Queen(mockHumanPlayer2), Coordinate2D(4, 7)),
            // Kings
            Pair(King(mockHumanPlayer1), Coordinate2D(5, 0)),
            Pair(King(mockHumanPlayer2), Coordinate2D(5, 7))
        )
