...
class Xiangqi : AbstractChess() {
    ...
    override fun initGame() {
        ...
        board.addPiece(Coordinate(2, 0), XiangqiElephant(player1))
        board.addPiece(Coordinate(6, 0), XiangqiElephant(player1))
        board.addPiece(Coordinate(2, 9), XiangqiElephant(player2))
        board.addPiece(Coordinate(6, 9), XiangqiElephant(player2))
