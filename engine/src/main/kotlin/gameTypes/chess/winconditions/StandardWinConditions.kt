...
class StandardWinConditions : WinCondition<AbstractChess> {
    private val winConditions: List<WinCondition<AbstractChess>> = listOf(Checkmate(), NoLegalMovesStalemate(), ThreeFoldRepetitionStalemate(), InsufficientMaterialStalemate(), FiftyMoveRuleStalemate())
